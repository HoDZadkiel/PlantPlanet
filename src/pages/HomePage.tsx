    ...
    <div>
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative hidden md:block">
              ...
              {/* Floating cards */}
              <div className="absolute -bottom-6 -left-6 bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-xl animate-pulse">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-green-100 dark:bg-green-900/40 rounded-full flex items-center justify-center text-lg">🌱</div>
                  <div>
                    <div className="text-sm font-semibold text-gray-800 dark:text-white">新植物加入</div>
                    <div className="text-xs text-gray-500">30 位成員分享了新植物</div>
                  </div>
                </div>
              </div>

              <div className="absolute -top-4 -right-4 bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-xl animate-pulse delay-300">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-green-100 dark:bg-green-900/40 rounded-full flex items-center justify-center text-lg">💬</div>
                  <div>
                    <div className="text-sm font-semibold text-gray-800 dark:text-white">活躍討論</div>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h2 className="text-3xl font-display font-bold text-gray-800 dark:text-white mb-2">論壇分類</h2>
            <p className="text-gray-500 dark:text-gray-400">選擇感興趣的話題，開始交流</p>
          </div>
          ...
          {categories.map((category) => (
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <span className="text-xs text-gray-400 dark:text-gray-500">{category.postCount} 篇貼文</span>
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-medium text-plant-primary bg-plant-light px-2.5 py-1 rounded-full dark:bg-green-900/40 dark:text-green-300">
                    {categories.find((c) => c.id === post.category)?.name}
                  </span>
                </div>
                {post.isPinned && (
                  <span className="text-xs font-medium text-amber-600 bg-amber-50 px-2.5 py-1 rounded-full dark:bg-amber-900/30 dark:text-amber-400">📌 置頂</span>
                )}
              </div>

              <h3 className="font-semibold text-gray-800 dark:text-white mb-2">{post.title}</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-4 line-clamp-2">{post.content}</p>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="card bg-gradient-to-br from-plant-primary to-plant-secondary border-0 text-white p-8 md:p-12 dark:from-green-800 dark:to-green-900">
